...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Rotating Triangle - Israt Sultana Tanny", NULL, NULL);
    if (window == NULL)
    {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        bool isGreen = glfwGetKey(window, GLFW_KEY_I) == GLFW_PRESS;
